...
public class Main {
	...
	public static int[][] mergeKautfteileVerwendung(int[][] p1KaufteileVerwendung2, int[][] p2KaufteileVerwendung2,
			int[][] p3KaufteileVerwendung2) {
		int[][] merged = { { 21, 0, 0, 0, 0, 0 }, { 22, 0, 0, 0, 0, 0 }, { 23, 0, 0, 0, 0, 0 }, { 24, 0, 0, 0, 0, 0 },
				{ 25, 0, 0, 0, 0, 0 }, { 27, 0, 0, 0, 0, 0 }, { 28, 0, 0, 0, 0, 0 }, { 32, 0, 0, 0, 0, 0 },
				{ 33, 0, 0, 0, 0, 0 }, { 34, 0, 0, 0, 0, 0 }, { 35, 0, 0, 0, 0, 0 }, { 36, 0, 0, 0, 0, 0 },
				{ 37, 0, 0, 0, 0, 0 }, { 38, 0, 0, 0, 0, 0 }, { 39, 0, 0, 0, 0, 0 }, { 40, 0, 0, 0, 0, 0 },
				{ 41, 0, 0, 0, 0, 0 }, { 42, 0, 0, 0, 0, 0 }, { 43, 0, 0, 0, 0, 0 }, { 44, 0, 0, 0, 0, 0 },
				{ 45, 0, 0, 0, 0, 0 }, { 46, 0, 0, 0, 0, 0 }, { 47, 0, 0, 0, 0, 0 }, { 48, 0, 0, 0, 0, 0 },
				{ 52, 0, 0, 0, 0, 0 }, { 53, 0, 0, 0, 0, 0 }, { 57, 0, 0, 0, 0, 0 }, { 58, 0, 0, 0, 0, 0 },
				{ 59, 0, 0, 0, 0, 0 } };
	...
	public static int[][] generiereKaufteileVerwendung(int produkt, int[][] Prod) {
		int[][] matrix = null;
		List<Article> articles = results.getWarehousestock().getArticle();
		if (produkt == 1) {
			int[][] p1 = {
					{ 21, findAmountById(articles, 21), 1 * Prod[0][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 22, findAmountById(articles, 22), 0 * Prod[0][7], 0 * prognosen[0][2], 0 * prognosen[0][3],
							0 * prognosen[0][4] },
					{ 23, findAmountById(articles, 23), 0 * Prod[0][7], 0 * prognosen[0][2], 0 * prognosen[0][3],
							0 * prognosen[0][4] },
					{ 24, findAmountById(articles, 24),
							1 * Prod[0][7] + 1 * Prod[2][7] + 1 * Prod[3][7] + 2 * Prod[5][7] + 2 * Prod[8][7],
							7 * prognosen[0][2], 7 * prognosen[0][3], 7 * prognosen[0][4] },
					{ 25, findAmountById(articles, 25), 1 * Prod[0][7] + 2 * Prod[5][7] + 2 * Prod[8][7],
							4 * prognosen[0][2], 4 * prognosen[0][3], 4 * prognosen[0][4] },
					{ 27, findAmountById(articles, 27), 1 * Prod[0][7] + 1 * Prod[2][7], 2 * prognosen[0][2],
							2 * prognosen[0][3], 2 * prognosen[0][4] },
					{ 28, findAmountById(articles, 28), 1 * Prod[3][7] + 3 * Prod[11][7], 4 * prognosen[0][2],
							4 * prognosen[0][3], 4 * prognosen[0][4] },
					{ 32, findAmountById(articles, 32), 1 * Prod[7][7] + 1 * Prod[10][7] + 1 * Prod[11][7],
							3 * prognosen[0][2], 3 * prognosen[0][3], 3 * prognosen[0][4] },
					{ 33, findAmountById(articles, 33), 0, 0, 0, 0 }, { 34, findAmountById(articles, 34), 0, 0, 0, 0 },
					{ 35, findAmountById(articles, 35), 2 * Prod[6][7] + 2 * Prod[9][7], 4 * prognosen[0][2],
							4 * prognosen[0][3], 4 * prognosen[0][4] },
					{ 36, findAmountById(articles, 36), 1 * Prod[6][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 37, findAmountById(articles, 37), 1 * Prod[6][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 38, findAmountById(articles, 38), 1 * Prod[6][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 39, findAmountById(articles, 39), 1 * Prod[7][7] + 1 * Prod[9][7], 2 * prognosen[0][2],
							2 * prognosen[0][3], 2 * prognosen[0][4] },
					{ 40, findAmountById(articles, 40), 1 * Prod[3][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 41, findAmountById(articles, 41), 1 * Prod[3][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 42, findAmountById(articles, 42), 2 * Prod[3][7], 2 * prognosen[0][2], 2 * prognosen[0][3],
							2 * prognosen[0][4] },
					{ 43, findAmountById(articles, 43), 1 * Prod[3][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 44, findAmountById(articles, 44), 2 * Prod[1][7] + 1 * Prod[3][7], 3 * prognosen[0][2],
							3 * prognosen[0][3], 3 * prognosen[0][4] },
					{ 45, findAmountById(articles, 45), 1 * Prod[4][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 46, findAmountById(articles, 46), 1 * Prod[4][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 47, findAmountById(articles, 47), 1 * Prod[4][7], 1 * prognosen[0][2], 1 * prognosen[0][3],
							1 * prognosen[0][4] },
					{ 48, findAmountById(articles, 48), 2 * Prod[4][7], 2 * prognosen[0][2], 2 * prognosen[0][3],
							2 * prognosen[0][4] },
					{ 52, findAmountById(articles, 52), 1 * Prod[4][7] + 1 * Prod[9][7], 2 * prognosen[0][2],
							2 * prognosen[0][3], 2 * prognosen[0][4] },
					{ 53, findAmountById(articles, 53), 36 * Prod[6][7] + 36 * Prod[9][7], 72 * prognosen[0][2],
							72 * prognosen[0][3], 72 * prognosen[0][4] },
					{ 57, findAmountById(articles, 57), 0, 0, 0, 0 }, { 58, findAmountById(articles, 58), 0, 0, 0, 0 },
					{ 59, findAmountById(articles, 59), 2 * Prod[11][7], 11 * prognosen[0][2], 11 * prognosen[0][3],
							11 * prognosen[0][4] } };
			matrix = p1;
		} else if (produkt == 2) {
			final int[][] p2 = { { 21, findAmountById(articles, 21), 0, 0, 0, 0 },
					{ 22, findAmountById(articles, 22), 1 * Prod[0][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 23, findAmountById(articles, 23), 0 * Prod[0][7], 0 * prognosen[1][2], 0 * prognosen[1][3],
							0 * prognosen[1][4] },
					{ 24, findAmountById(articles, 24),
							1 * Prod[0][7] + 1 * Prod[2][7] + 1 * Prod[3][7] + 2 * Prod[5][7] + 2 * Prod[8][7],
					...
					{ 27, findAmountById(articles, 27), 1 * Prod[0][7] + 1 * Prod[2][7], 2 * prognosen[1][2],
							2 * prognosen[1][3], 2 * prognosen[1][4] },
					{ 28, findAmountById(articles, 28), 1 * Prod[3][7] + 4 * Prod[11][7], 5 * prognosen[1][2],
							5 * prognosen[1][3], 5 * prognosen[1][4] },
					{ 32, findAmountById(articles, 32), 1 * Prod[7][7] + 1 * Prod[10][7] + 1 * Prod[11][7],
							3 * prognosen[1][2], 3 * prognosen[1][3], 3 * prognosen[1][4] },
					{ 33, findAmountById(articles, 33), 0, 0, 0, 0 }, { 34, findAmountById(articles, 34), 0, 0, 0, 0 },
					{ 35, findAmountById(articles, 35), 2 * Prod[6][7] + 2 * Prod[9][7], 4 * prognosen[1][2],
							4 * prognosen[1][3], 4 * prognosen[1][4] },
					{ 36, findAmountById(articles, 36), 1 * Prod[6][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 37, findAmountById(articles, 37), 1 * Prod[9][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 38, findAmountById(articles, 38), 1 * Prod[9][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 39, findAmountById(articles, 39), 1 * Prod[7][7] + 1 * Prod[9][7], 2 * prognosen[1][2],
							2 * prognosen[1][3], 2 * prognosen[1][4] },
					{ 40, findAmountById(articles, 40), 1 * Prod[3][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 41, findAmountById(articles, 41), 1 * Prod[3][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 42, findAmountById(articles, 42), 2 * Prod[3][7], 2 * prognosen[1][2], 2 * prognosen[1][3],
							2 * prognosen[1][4] },
					{ 43, findAmountById(articles, 43), 1 * Prod[4][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 44, findAmountById(articles, 44), 2 * Prod[1][7] + 1 * Prod[4][7], 3 * prognosen[1][2],
							3 * prognosen[1][3], 3 * prognosen[1][4] },
					{ 45, findAmountById(articles, 45), 1 * Prod[4][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 46, findAmountById(articles, 46), 1 * Prod[4][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 47, findAmountById(articles, 47), 1 * Prod[1][7], 1 * prognosen[1][2], 1 * prognosen[1][3],
							1 * prognosen[1][4] },
					{ 48, findAmountById(articles, 48), 2 * Prod[1][7], 2 * prognosen[1][2], 2 * prognosen[1][3],
							2 * prognosen[1][4] },
					{ 52, findAmountById(articles, 52), 0, 0, 0, 0 }, { 53, findAmountById(articles, 53), 0, 0, 0, 0 },
					{ 57, findAmountById(articles, 57), 1 * Prod[6][7] + 1 * Prod[9][7], 2 * prognosen[1][2],
							2 * prognosen[1][3], 2 * prognosen[1][4] },
					{ 58, findAmountById(articles, 58), 36 * Prod[6][7] + 36 * Prod[9][7], 72 * prognosen[1][2],
							72 * prognosen[1][3], 72 * prognosen[1][4] },
					{ 59, findAmountById(articles, 59), 2 * Prod[11][7], 11 * prognosen[1][2], 11 * prognosen[1][3],
							11 * prognosen[1][4] } };
			matrix = p2;
		} else if (produkt == 3) {
			final int[][] p3 = { { 21, findAmountById(articles, 21), 0, 0, 0, 0 },
					{ 22, findAmountById(articles, 22), 0, 0, 0, 0 },
					{ 23, findAmountById(articles, 23), 1 * Prod[0][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 24, findAmountById(articles, 24),
							1 * Prod[0][7] + 1 * Prod[2][7] + 1 * Prod[3][7] + 2 * Prod[5][7] + 2 * Prod[8][7],
					...
					{ 27, findAmountById(articles, 27), 1 * Prod[0][7] + 1 * Prod[2][7], 2 * prognosen[2][2],
							2 * prognosen[2][3], 2 * prognosen[2][4] },
					{ 28, findAmountById(articles, 28), 1 * Prod[3][7] + 5 * Prod[11][7], 6 * prognosen[2][2],
							6 * prognosen[2][3], 6 * prognosen[2][4] },
					{ 32, findAmountById(articles, 32), 1 * Prod[7][7] + 1 * Prod[10][7] + 1 * Prod[11][7],
							3 * prognosen[2][2], 3 * prognosen[2][3], 3 * prognosen[2][4] },
					{ 33, findAmountById(articles, 33), 1 * Prod[6][7] + 1 * Prod[9][7], 2 * prognosen[2][2],
							2 * prognosen[2][3], 2 * prognosen[2][4] },
					{ 34, findAmountById(articles, 34), 36 * Prod[6][7] + 36 * Prod[9][7], 72 * prognosen[2][2],
							72 * prognosen[2][3], 72 * prognosen[2][4] },
					{ 35, findAmountById(articles, 35), 2 * Prod[6][7] + 2 * Prod[9][7], 4 * prognosen[2][2],
							4 * prognosen[2][3], 4 * prognosen[2][4] },
					{ 36, findAmountById(articles, 36), 1 * Prod[6][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 37, findAmountById(articles, 37), 1 * Prod[9][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 38, findAmountById(articles, 38), 1 * Prod[9][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 39, findAmountById(articles, 39), 1 * Prod[7][7] + 1 * Prod[9][7], 2 * prognosen[2][2],
							2 * prognosen[2][3], 2 * prognosen[2][4] },
					{ 40, findAmountById(articles, 40), 1 * Prod[3][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 41, findAmountById(articles, 41), 1 * Prod[3][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 42, findAmountById(articles, 42), 2 * Prod[3][7], 2 * prognosen[2][2], 2 * prognosen[2][3],
							2 * prognosen[2][4] },
					{ 43, findAmountById(articles, 43), 1 * Prod[4][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 44, findAmountById(articles, 44), 2 * Prod[1][7] + 1 * Prod[4][7], 3 * prognosen[2][2],
							3 * prognosen[2][3], 3 * prognosen[2][4] },
					{ 45, findAmountById(articles, 45), 1 * Prod[4][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 46, findAmountById(articles, 46), 1 * Prod[4][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 47, findAmountById(articles, 47), 1 * Prod[1][7], 1 * prognosen[2][2], 1 * prognosen[2][3],
							1 * prognosen[2][4] },
					{ 48, findAmountById(articles, 48), 2 * Prod[1][7], 2 * prognosen[2][2], 2 * prognosen[2][3],
							2 * prognosen[2][4] },
					{ 52, findAmountById(articles, 52), 0, 0, 0, 0 }, { 53, findAmountById(articles, 53), 0, 0, 0, 0 },
					{ 57, findAmountById(articles, 57), 0, 0, 0, 0 }, { 58, findAmountById(articles, 58), 0, 0, 0, 0 },
					{ 59, findAmountById(articles, 59), 2 * Prod[11][7], 11 * prognosen[2][2], 11 * prognosen[2][3],
							11 * prognosen[2][4] } };
			matrix = p3;
		}
	...
	public static int[][] matrixAnlegen(int geplanterLagerbestand, int geplantVerkauf, int produktionFall,
			Results results) {
		// Artikel ermitteln
		List<Article> articles = results.getWarehousestock().getArticle();
		...
		if (produktionFall == 1) {
			int[][] matrix1 = { { 1, geplantVerkauf, 0, geplanterLagerbestand, findAmountById(articles, 1), 0, 0, 0 },
		...
		for (Integer artikelNummer : artikelInWarteschlange.keySet()) {
			ersetzeWarteschlangenItems(matrix, artikelNummer, artikelInWarteschlange.get(artikelNummer));
		}

		for (Integer artikelNummer : artikelInBearbeitung.keySet()) {
			ersetzeInBearbeitungItems(matrix, artikelNummer, artikelInBearbeitung.get(artikelNummer));
		}
	...
	private static void ersetzeWarteschlangenItems(int[][] matrix, Integer artikelNummer, Integer artikelMenge) {
	...
	private static void ersetzeInBearbeitungItems(int[][] matrix, Integer artikelNummer, Integer artikelMenge) {
		int zeilenNummer = artikelVorhanden(matrix, artikelNummer);
		// 12 bedeutet nicht vorhanden, da matrix nur bis 12 geht
		if (zeilenNummer != 12) {
	...
	private static int findAmountById(List<Article> articles, int i) {
		for (Article article : articles) {
			if (article.getId().intValue() == i) {
				int intValue = article.getAmount().intValue();
